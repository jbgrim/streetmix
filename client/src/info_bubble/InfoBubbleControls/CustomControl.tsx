...
export default function CustomControl ({ position }: CustomControlsProps) {
  ...
  return (
    <div className="non-variant">
      <p>Valeurs au mètre linéaire (ml)</p>
      <div
        style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}
      >
        <p style={{ marginRight: '1em' }}>Prix :</p>
        <UpDownInput
          value={eur}
          minValue={0}
          maxValue={10000}
      ...
      <div
        style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}
      >
        <p style={{ marginRight: '1em' }}>Prix (30 ans) : </p>
        <UpDownInput
          value={eur30}
          minValue={0}
          maxValue={10000}
      ...
      <div
        style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}
      >
        <p style={{ marginRight: '1em' }}>Co2 (30 ans) : </p>
        <UpDownInput
          value={co230}
          minValue={0}
          maxValue={10000}
