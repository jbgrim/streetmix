...
function AdminConfigurationDialog(): React.ReactElement {
  ...
  const [isPavementStructureLoading, setIsPavementStructureLoading] = useState(false)
  const [columnDefs] = useState<ColDef<ElementColumnData>[]>([
    ...
    { field: 'roulement', headerName: 'Roulement', editable: true, hide: false },
    ...
    { field: 'sur30CountEur', headerName: 'Sur 30 Count €', editable: true, hide: false },
    { field: 'sur30CountCo2', headerName: 'Sur 30 Count Co2', editable: true, hide: false }
  ])
  ...
  >([
    { field: 'nom', headerName: 'Nom', hide: false },
    { field: 'prixProjet', headerName: 'Prix Projet', editable: true, hide: false },
    { field: 'co2Projet', headerName: 'CO2 Projet', editable: true, hide: false },
    { field: 'prixSur30Ans', headerName: 'Prix Sur 30 Ans', editable: true, hide: false },
    { field: 'co2Sur30Ans', headerName: 'CO2 Sur 30 Ans', editable: true, hide: false }
  ])
  ...
  const handleSave = async (type: 'element' | 'pavementStructure') => {
    ...
    const currentGridRef = type === 'element' ? elementGridRef : pavementStructureGridRef
